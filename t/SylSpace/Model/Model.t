...
subtest 'miscellaneous tools' => sub {
  ok readschema('u'), 'user schema can be read';
};

subtest 'Creating two test courses' => sub {
...
subtest 'New or existing users' => sub {
...
subtest 'Create bio for instructor@gmail.com' => sub {
...
subtest 'Creating course info for one test course' => sub {
...
my $courseHaPtr;
subtest 'Test enrollment with student bio lacked' => sub {
...
subtest 'Test enrollment with course info lacked' => sub {
  skip_all 'write these tests';
};


subtest 'Enroll or disroll student or instructor' => sub {
  ok( $courseHaPtr=courselistenrolled($iemail));
...
subtest 'Courses and students linkage test' => sub {
  skip_all 'write these tests';
};

subtest 'Instructor and Student status test' => sub {
  skip_all 'write these tests';
};
