...
%layout 'auth';
  ...
  <p>The source code for SylSpace, running on this <%= sitename %> site, is public on <a href="https://github.com/iwelch/sylspace">github</a>, so it is not a security breach if you learn details about where the error has occurred (or a little more information why).</p>

  <p>However, if you notice a compromise of internal data that you should not have seen, or if you discover an exploitable security breach, please contact <a href="mailto:ivo.welch@gmail.com?subject=security breach on <%= sitename %>">ivo welch</a> urgently.</p>
